...
bool wrapper_text_stack_starts_with(void *text_stack, const char *element) {
  CTextStack *stack = (CTextStack *)text_stack;
  return CTextStack_starts_with(stack, element);
}

bool wrapper_text_stack_ends_with(void *text_stack, const char *element) {
  CTextStack *stack = (CTextStack *)text_stack;
  return CTextStack_ends_with(stack, element);
}

bool wrapper_text_stack_equal(void *text_stack, const char *element) {
  CTextStack *stack = (CTextStack *)text_stack;
  return CTextStack_equal(stack, element);
}
...
bool wrapper_text_stack_is_a_num(void *text_stack) {
  CTextStack *stack = (CTextStack *)text_stack;
  return CTextStack_is_a_num(stack);
}
...
bool wrapper_text_stack_parse_to_bool(void *text_stack) {
  CTextStack *stack = (CTextStack *)text_stack;
  return CTextStack_parse_to_bool(stack);
}
