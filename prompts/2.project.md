...
|-------------------------------|----------------------------------------------------------------------|
| Logo/Blog name                | `/`                                                                  |
| "Lua" button                  | `/list_articles?page=1&category=lua&limit=10`                        |
| "C" button                    | `/list_articles?page=1&category=C&limit=10`                          |
| "Vibecoding" button           | `/list_articles?page=1&category=Vibecoding&limit=10`                 |
| "Software Architecture" button| `/list_articles?page=1&category=Software+Architecture&limit=10`      |
